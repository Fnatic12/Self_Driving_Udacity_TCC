...
##python train.py -d /Users/victormilani/data_udacity -c driving_log.csv -t 0.2 -n 100 -b 16 -o True -m nvidia##
#python train.py -d /Users/victormilani/data_udacity -c driving_log.csv -t 0.2 -n 100 -b 16 -o True -m comma#

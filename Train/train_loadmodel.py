...
##python train_loadmodel.py -d /Users/victormilani/data_udacity -c driving_log.csv -t 0.2 -n 78 -b 16 -o True -m nvidia##
#python train.py -d /Users/victormilani/data_udacity -c driving_log.csv -t 0.2 -n 78 -b 16 -o True -m comma#
...
def main():
    ...
    if args.model_name == 'nvidia':
        model = load_model("/Users/victormilani/udacity_tcc/Train/model_nvidia-022.h5", compile=False)
        model.compile(
            optimizer=Adam(learning_rate=0.0003, decay=1e-6),
            loss={'steering': 'mse', 'throttle': 'mse'},
            loss_weights={'steering': 1.0, 'throttle': 1.0}
        ...
        model = load_model("/Users/victormilani/udacity_tcc/Train/model_comma-022.h5", compile=False)
        model.compile(
            optimizer=Adam(learning_rate=0.0003),
            loss={'steering': 'mse', 'throttle': 'mse'},
            loss_weights={'steering': 1.0, 'throttle': 1.0}
